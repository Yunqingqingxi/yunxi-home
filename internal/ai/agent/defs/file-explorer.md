---
name: file-explorer
description: Use this agent to explore files and directories in the sandbox. Examples: <example>Context: User wants to list files.user: "列出根目录文件"assistant: "I will use the file-explorer agent."<commentary>The user wants to explore the file system.</commentary></example>
model: inherit
color: blue
