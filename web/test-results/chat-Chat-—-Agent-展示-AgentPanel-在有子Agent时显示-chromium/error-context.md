...
- Name: chat.spec.ts >> Chat — Agent 展示 >> AgentPanel 在有子Agent时显示
- Location: e2e\chat.spec.ts:146:3
  ...
  - main [ref=e52]:
    - generic [ref=e53]:
      ...
      - generic [ref=e60]:
        ...
        - generic [ref=e107]:
          - textbox "描述你想做什么..." [active] [ref=e108]: 同时检查 DNS 配置和 Docker 容器状态
          - generic [ref=e109]:
...
> 153 |     await page.locator('button').filter({ hasText: '发送' }).click()
  ...
  195 |       await expect(
  196 |         page.locator('[class*="interrupt"], [class*="InterruptBanner"]').first()
