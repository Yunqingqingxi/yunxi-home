...
Locator: locator('textbox[placeholder*="描述"]')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for locator('textbox[placeholder*="描述"]')
...
```ts
  ...
  31  | 
  32  |     // Chat input
  33  |     const input = page.locator('textbox[placeholder*="描述"]')
> 34  |     await expect(input).toBeVisible({ timeout: 10000 })
  ...
  52  | 
  53  |     const input = page.locator('textbox[placeholder*="描述"]')
  ...
  72  | 
  73  |     const input = page.locator('textbox[placeholder*="描述"]')
  ...
  93  |     const input = page.locator('textbox[placeholder*="描述"]')
  ...
  125 | 
  126 |     const input = page.locator('textbox[placeholder*="描述"]')
